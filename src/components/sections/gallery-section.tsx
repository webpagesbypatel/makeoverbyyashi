...
const galleryItems = [
  ...
  { src: "https://images.unsplash.com/photo-1512290923902-8a9f81dc236c?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3NDE5ODJ8MHwxfHNlYXJjaHwxNHx8YmVhdXR5JTIwcGFybG91cnxlbnwwfHx8fDE3NDg2OTk2NzB8MA&ixlib=rb-4.1.0&q=80&w=1080", alt: "Beauty parlour", dataAiHint: "beauty parlour" },
